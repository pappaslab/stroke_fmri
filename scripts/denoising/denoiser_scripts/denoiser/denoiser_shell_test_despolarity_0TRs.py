...
for sub in ['201', '202', '203', '204', '205', '206', '207', '208', '209', '210', '211', '212', '213', '214', '215', '216','217','218','219','220','221','222','223']:
#for sub in [01, 1008, 1009, 1016, 1021, 1027, 1032, 1037, 1042, 1005, 1011, 1017, 1022, 1028, 1033, 1038, 1043, 1006, 1012, 1018, 1023, 1029, 1034, 1039, 1044, 1007, 1014, 1019, 1024, 1030, 1035, 1040, 1015, 1020, 1026, 1031, 1036, 1041]: #np.arange(1,73):
	...
	for run in runs:
		...
		img_file_str = '/home/despoC/ycleong/Desktop/ISFC_Diff/Datasets/preproc/Despolarity/fmriprep/sub-%s/ses-002/func/sub-%s_ses-002_task-rest_run-00%s_bold_space-%s_preproc.nii.gz' %(sub, sub, run, epi_space)
		
		tsv_file_str = '/home/despoC/ycleong/Desktop/ISFC_Diff/Datasets/preproc/Despolarity/fmriprep/sub-%s/ses-002/func/sub-%s_ses-002_task-rest_run-00%s_bold_confounds.tsv' %(sub, sub, run)
		out_path = '/home/despoC/ioannis/Berkeley_research1/YC/data/derivatives_despolarity/aux_data/sub-%s/denoise/' %(sub)
