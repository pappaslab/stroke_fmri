...
for sub in ['023','052','084','090','096','102','108','030','065','085','091','097','103','109','032','066','086','092','098','104','110','034','079','087','093','099',       '105','111','038','081','088','094','100','106','050','083','089','095','101','107']:
#for sub in [01, 1008, 1009, 1016, 1021, 1027, 1032, 1037, 1042, 1005, 1011, 1017, 1022, 1028, 1033, 1038, 1043, 1006, 1012, 1018, 1023, 1029, 1034, 1039, 1044, 1007, 1014, 1019, 1024, 1030, 1035, 1040, 1015, 1020, 1026, 1031, 1036, 1041]: #np.arange(1,73):
	...
	for i in range(1):
		...
		img_file_str = '/home/despoC/ycleong/Desktop/ISFC_Diff/Datasets/preproc/Prettymouth/fmriprep/sub-%s/func/sub-%s_task-prettymouth_bold_space-%s_preproc.nii.gz' %(sub, sub,  epi_space)

		tsv_file_str = '/home/despoC/ycleong/Desktop/ISFC_Diff/Datasets/preproc/Prettymouth/fmriprep/sub-%s/func/sub-%s_task-prettymouth_bold_confounds.tsv' %(sub, sub)
		out_path = '/home/despoC/ioannis/Berkeley_research1/YC/data/derivatives_mouth/aux_data/sub-%s' %(sub)

		if not os.path.isdir(out_path):
			os.mkdir(out_path)
		out_path = '/home/despoC/ioannis/Berkeley_research1/YC/data/derivatives_mouth/aux_data/sub-%s/denoise/' %(sub)
