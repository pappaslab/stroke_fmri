...
for sub in ['3592', '3784', '2994', '3602', '3810', '3920', '3977', '4572', '3132', '3626', '3240', '3646', '3846', '3929', '4450', '3279', '3744', '3512', '3757', '3858', '3964', '4547']:
#for sub in ['4547']:
#for sub in [01, 1008, 1009, 1016, 1021, 1027, 1032, 1037, 1042, 1005, 1011, 1017, 1022, 1028, 1033, 1038, 1043, 1006, 1012, 1018, 1023, 1029, 1034, 1039, 1044, 1007, 1014, 1019, 1024, 1030, 1035, 1040, 1015, 1020, 1026, 1031, 1036, 1041]: #np.arange(1,73):
	...
	for run in runs:
		...
		img_file_str = '/home/despoC/ycleong/Desktop/ISFC_Diff/Datasets/preproc/Paranoia/fmriprep/sub-tb%s/func/sub-tb%s_task-story%s_bold_space-%s_preproc.nii.gz' %(sub, sub, run, epi_space)

		tsv_file_str = '/home/despoC/ycleong/Desktop/ISFC_Diff/Datasets/preproc/Paranoia/fmriprep/sub-tb%s/func/sub-tb%s_task-story%s_bold_confounds.tsv' %(sub, sub, run)
		out_path1 = '/home/despoC/ioannis/Berkeley_research1/YC/data/derivatives_paranoia/aux_data/sub-tb%s/' %(sub)

		if not os.path.isdir(out_path1):
			os.mkdir(out_path1)

		out_path = '/home/despoC/ioannis/Berkeley_research1/YC/data/derivatives_paranoia/aux_data/sub-tb%s/denoise/' %(sub)
