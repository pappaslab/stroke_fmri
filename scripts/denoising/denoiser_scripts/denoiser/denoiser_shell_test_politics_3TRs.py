...
for sub in [1004, 1008, 1009, 1016, 1021, 1027, 1032, 1037, 1042, 1005, 1011, 1017, 1022, 1028, 1033, 1038, 1043, 1006, 1012, 1018, 1023, 1029, 1034, 1039, 1044, 1007, 1014, 1019, 1024, 1030, 1035, 1040, 1015, 1020, 1026, 1031, 1036, 1041]: #np.arange(1,73):
	#if sub in [8, 19, 56]:
	#	continue
	for run in runs:

		img_file_str = '/home/despoC/ycleong/Desktop/ISFC_Diff/Datasets/preproc/Polarization/fmriprep/sub-%04d/func/sub-%04d_task-run%s_bold_space-%s_preproc.nii.gz' %(sub, sub, run, epi_space)
		system_call = 'cp '+img_file_str+' '+'/home/despoC/ioannis/dum'
		os.system(system_call)
		system_call = 'cd /home/despoC/ioannis/dum'
		os.system(system_call)
		system_call = 'fslsplit /home/despoC/ioannis/dum/sub-%04d_task-run%s_bold_space-%s_preproc.nii.gz' %(sub, run, epi_space)
		os.system(system_call)
		system_call ='rm /home/despoC/ioannis/dum/sub-%04d_task-run%s_bold_space-%s_preproc.nii.gz' %(sub, run, epi_space)
		os.system(system_call)
		system_call = 'rm vol0000.nii.gz'
		os.system(system_call)
		system_call = 'rm vol0001.nii.gz'
		os.system(system_call)
		system_call = 'rm vol0002.nii.gz'
		os.system(system_call)
		system_call = 'fslmerge -t sub-%04d_task-run%s_bold_space-%s_preproc.nii.gz vol*' %(sub, run, epi_space) 
		os.system(system_call)
		#pdb.set_trace()
		system_call = 'rm vol*'
		os.system(system_call)
		img_file_str='/home/despoC/ioannis/sub-%04d_task-run%s_bold_space-%s_preproc.nii.gz' %(sub, run, epi_space) 
		tsv_file_str = '/home/despoC/ycleong/Desktop/ISFC_Diff/Datasets/preproc/Polarization/fmriprep/sub-%04d/func/sub-%04d_task-run%s_bold_confounds.tsv' %(sub, sub, run)
		out_path = '/home/despoC/ioannis/Berkeley_research1/YC/data/derivatives_politics/aux_data/sub-%04d/denoise/' %(sub)
